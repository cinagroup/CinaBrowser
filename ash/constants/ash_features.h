...
COMPONENT_EXPORT(ASH_CONSTANTS) BASE_DECLARE_FEATURE(kFjordOobeForSquid);
COMPONENT_EXPORT(ASH_CONSTANTS)
...
COMPONENT_EXPORT(ASH_CONSTANTS)
BASE_DECLARE_FEATURE(kGoogleServicesConnectivityRoutine);
...
COMPONENT_EXPORT(ASH_CONSTANTS) bool IsFjordOobeForSquidEnabled();
