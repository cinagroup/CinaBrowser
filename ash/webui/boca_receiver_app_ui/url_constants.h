...
#ifndef ASH_WEBUI_BOCA_RECEIVER_APP_UI_URL_CONSTANTS_H_
#define ASH_WEBUI_BOCA_RECEIVER_APP_UI_URL_CONSTANTS_H_
...
#endif  // ASH_WEBUI_BOCA_RECEIVER_APP_UI_URL_CONSTANTS_H_
