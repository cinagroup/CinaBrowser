...
#ifndef REMOTING_PROTOCOL_PSEUDO_TCP_H_
#define REMOTING_PROTOCOL_PSEUDO_TCP_H_
 ...
 private:
  ...
  class LockedFifoBuffer final {
   ...
   private:
    ...
    size_t read_position_ GUARDED_BY(lock_);
    mutable base::Lock lock_;
  };

  raw_ptr<IPseudoTcpNotify> m_notify;
...
#endif  // REMOTING_PROTOCOL_PSEUDO_TCP_H_
