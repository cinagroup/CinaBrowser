...
// Certficate with the subject CN set to "Cinaseek", the subject organisation
// set to "The Cinaseek Projects", and the subject organizational unit set to
// "Security."
...
// "The Cinaseek Projects" and the subject origanisational unit is set to
// "Security".
...
TEST(CertUtilTest, ExtractSubjectNameFromCertificate) {
  ...
  EXPECT_EQ("The Cinaseek Projects Security", name2);
