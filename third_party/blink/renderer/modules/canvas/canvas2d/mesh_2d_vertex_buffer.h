...
class MODULES_EXPORT Mesh2DVertexBuffer final : public Mesh2DBuffer<SkPoint> {
 ...
 public:
  explicit Mesh2DVertexBuffer(scoped_refptr<cc::RefCountedBuffer<SkPoint>> buf)
      : Mesh2DBuffer(std::move(buf)) {}
  ~Mesh2DVertexBuffer() override = default;
};

}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_MODULES_CANVAS_CANVAS2D_MESH_2D_VERTEX_BUFFER_H_
