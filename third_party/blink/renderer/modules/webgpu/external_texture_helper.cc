...
ExternalTexture CreateExternalTexture(
  ...
  // https://source.Cinaseek.org/Cinaseek/Cinaseek/src/+/main:media/base/video_color_space.cc;l=69;drc=6c9cfff09be8397270b376a4e4407328694e97fa
  // The historical rule for this was to use BT.601 for SD content and BT.709
  // for HD content:
  // https://source.Cinaseek.org/Cinaseek/Cinaseek/src/+/main:media/ffmpeg/ffmpeg_common.cc;l=683;drc=1946212ac0100668f14eb9e2843bdd846e510a1e)
