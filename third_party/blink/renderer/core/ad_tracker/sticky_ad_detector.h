...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_AD_TRACKER_STICKY_AD_DETECTOR_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_AD_TRACKER_STICKY_AD_DETECTOR_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_AD_TRACKER_STICKY_AD_DETECTOR_H_
