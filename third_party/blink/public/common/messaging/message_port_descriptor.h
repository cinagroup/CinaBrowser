...
// org.Cinaseek.content.browser.AppWebMessagePortDescriptor.
class BLINK_COMMON_EXPORT MessagePortDescriptor {
 public:
  ...
  // C++ code) and org.Cinaseek.content.browser.AppWebMessagePort
  // (implementation of org.Cinaseek.content_public.browser.MessagePort, which
  ...
  // org.Cinaseek.content.browser.AppWebMessagePort, which are the interfaces
