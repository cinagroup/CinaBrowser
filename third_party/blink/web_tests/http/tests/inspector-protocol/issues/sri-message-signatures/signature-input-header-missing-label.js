...
(async function(/** @type {import('test_runner').TestRunner} */ testRunner) {
  const {page, session, dp} = await testRunner.startBlank("Verifies issue creation for a mismatched `Signature-Input` label.");
  ...
  testURL.searchParams.set('input', `not-` + valid_signature_input);
