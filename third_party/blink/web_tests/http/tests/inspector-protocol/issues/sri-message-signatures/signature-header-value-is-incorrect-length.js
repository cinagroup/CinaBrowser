...
(async function(/** @type {import('test_runner').TestRunner} */ testRunner) {
  const {page, session, dp} = await testRunner.startBlank("Verifies issue creation for a `Signature` header whose value is the incorrect length.");
  ...
  testURL.searchParams.set('signature', `signature=:BADBEEF:`);
