...
(async function(/** @type {import('test_runner').TestRunner} */ testRunner) {
  const {page, session, dp} = await testRunner.startBlank("Verifies issue creation for a `Signature-Input` whose parameters are unknown.");
  ...
  testURL.searchParams.set('input', valid_signature + ";unknown=param");
