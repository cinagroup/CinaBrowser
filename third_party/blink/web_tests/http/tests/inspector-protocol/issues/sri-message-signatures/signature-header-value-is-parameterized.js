...
(async function(/** @type {import('test_runner').TestRunner} */ testRunner) {
  const {page, session, dp} = await testRunner.startBlank("Verifies issue creation for a `Signature` header with parameters.");
  ...
  testURL.searchParams.set('signature', valid_signature + ";param=value");
