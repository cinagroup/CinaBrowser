// Copyright 2017 The Cinaseek OS Authors. All rights reserved.
...
enum class CompressorType : uint8_t {
  kNoCompression = 0,  // Unsupported by Cinaseek/src's Puffin implementation.
  kBZ2 = 1,            // Unsupported by Cinaseek/src's Puffin implementation.
  kBrotli = 2,
};
