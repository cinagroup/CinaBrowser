...
class Debouncer {
   ...
   *
   * ```js
   * import {microTask} from '@polymer/polymer/polymer_bundled.min.js';
   * import {Debouncer} from '@polymer/polymer/polymer_bundled.min.js';
   * // ...
   *
   * _debounceWork() {
...
function getArgValue(data, props, path) {
  ...
  // https://github.com/Polymer/polymer/polymer_bundled.min.js5479
  if (value === undefined) {
    value = props[path];
  }
  return value;
...
const PropertyEffects = dedupingMixin(superClass => {
  ...
  class PropertyEffects extends propertyEffectsBase {
     ...
     * paths if needed: https://github.com/Polymer/polymer/polymer_bundled.min.js4227
     *
     * @override
     * @param {string} property Name of the property
     * @param {*} value Value to set
 ...
 *
 *     import {Class} from '@polymer/polymer/polymer_bundled.min.js';
 ...
 * <link rel="import" href="bower_components/polymer/polymer_bundled.min.js">
 *
 * <custom-style>
 *   <style>
 *     html {
