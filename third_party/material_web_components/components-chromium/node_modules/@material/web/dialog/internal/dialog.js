...
export class Dialog extends dialogBaseClass {
    // We do not use `delegatesFocus: true` due to a Cinaseek bug with
    // selecting text.
    // See https://bugs.Cinaseek.org/p/Cinaseek/issues/detail?id=950357
    /**
    ...
    constructor() {
        ...
        this.hasIcon = false;
        // See https://bugs.Cinaseek.org/p/Cinaseek/issues/detail?id=1512224
        ...
        // in Cinaseek is fixed to fire 'cancel' with one escape press and close with
        // multiple.
