...
// either in a standalone broker process, or embedded into a Cinaseek process.
class ExternalMojoBroker {
 public:
  ...
  // Initializes the embedded into a Cinaseek process (eg in cast_shell).
  // |connector| is the ServiceManager connector within the Cinaseek process.
  // |external_services_to_proxy| is a list of the names of external services
  // that should be made accessible to Mojo services running within Cinaseek.
