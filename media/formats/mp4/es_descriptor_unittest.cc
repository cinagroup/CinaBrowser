...
TEST(ESDescriptorTest, SingleByteLengthTest) {
  ...
  std::vector<uint8_t> data = {
      0x03, 0x19, 0x00, 0x01, 0x00, 0x04, 0x11, 0x40, 0x15,
...
TEST(ESDescriptorTest, NonAACTest) {
  ESDescriptor es_desc;
  std::vector<uint8_t> data = {
      0x03, 0x19, 0x00, 0x01, 0x00, 0x04, 0x11, 0x66, 0x15,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x05, 0x02, 0x12, 0x10, 0x06, 0x01, 0x02,
  };
...
TEST(ESDescriptorTest, MultiByteLengthTest) {
  ESDescriptor es_desc;
  std::vector<uint8_t> data = {
      0x03, 0x80, 0x19, 0x00, 0x01, 0x00, 0x04, 0x80, 0x80, 0x11, 0x40,
      0x15, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x05, 0x80, 0x80, 0x80, 0x02, 0x12, 0x10, 0x06, 0x01, 0x02,
  };
...
TEST(ESDescriptorTest, FiveByteLengthTest) {
  ESDescriptor es_desc;
  std::vector<uint8_t> data = {
      0x03, 0x80, 0x19, 0x00, 0x01, 0x00, 0x04, 0x80, 0x80, 0x11, 0x40, 0x15,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05,
      0x80, 0x80, 0x80, 0x80, 0x02, 0x12, 0x10, 0x06, 0x01, 0x02,
  };
