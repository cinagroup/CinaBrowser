...
// Translates Video4Linux pixel formats to Cinaseek pixel formats.
// static
VideoPixelFormat VideoCaptureDeviceLinux::V4l2FourCcToCinaseekPixelFormat(
    uint32_t v4l2_fourcc) {
  return V4L2CaptureDelegate::V4l2FourCcToCinaseekPixelFormat(v4l2_fourcc);
}
