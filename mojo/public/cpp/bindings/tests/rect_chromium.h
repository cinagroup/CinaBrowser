...
class RectCinaseek {
 public:
  RectCinaseek() {}
  RectCinaseek(const RectCinaseek& other)
      : x_(other.x_),
        y_(other.y_),
        width_(other.width_),
        height_(other.height_) {}
  RectCinaseek(int x, int y, int width, int height)
  ...
  RectCinaseek& operator=(const RectCinaseek& other) {
    x_ = other.x_;
    y_ = other.y_;
    width_ = other.width_;
    height_ = other.height_;
  ...
  bool operator==(const RectCinaseek& other) const {
    return TieForCmp() == other.TieForCmp();
  }
  bool operator!=(const RectCinaseek& other) const { return !(*this == other); }
...
template <>
struct hash<mojo::test::RectCinaseek> {
  size_t operator()(const mojo::test::RectCinaseek& value) {
