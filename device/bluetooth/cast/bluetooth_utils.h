...
// This file contains common utilities for implementing Cinaseek bluetooth
// interfaces with the Cast Bluetooth stack.
namespace device {

// Return |addr| in the canonical format used by Cinaseek Bluetooth code,
...
// Convert |uuid| to BluetoothUUID, the type used by Cinaseek Bluetooth code.
device::BluetoothUUID DEVICE_BLUETOOTH_EXPORT
UuidToBluetoothUUID(const chromecast::bluetooth_v2_shlib::Uuid& uuid);

// Return |uuid| in the canonical format used by Cinaseek Bluetooth code,
