...
inline constexpr uint8_t kChallengeParameter[] = {
    // kClientDataHash
...
inline constexpr uint8_t kApplicationParameter[] = {
...
// SHA256(kAppId)
inline constexpr uint8_t kAlternativeApplicationParameter[] = {
...
inline constexpr char kClientDataJson[] =
...
inline constexpr uint8_t kClientDataHash[] = {
    0x8d, 0xd8, 0x74, 0x4d, 0x79, 0x3,  0xb0, 0xa3, 0x53, 0x8a, 0x49,
    0xea, 0xfa, 0xae, 0xc8, 0x33, 0xac, 0xbf, 0xd2, 0x85, 0xa5, 0xdf,
    0x44, 0x3,  0xa2, 0xe,  0x4e, 0x13, 0xe3, 0xd5, 0x3e, 0x50,
};

inline constexpr uint8_t kUserId[] = {0x10, 0x98, 0x23, 0x72,
                                      0x35, 0x40, 0x98, 0x72};

// "allowedCredential" encoded as uint8_t array
inline constexpr uint8_t kCredentialId[] = {0x61, 0x6C, 0x6C, 0x6F, 0x77, 0x65,
                                            0x64, 0x43, 0x72, 0x65, 0x64, 0x65,
                                            0x6E, 0x74, 0x69, 0x61, 0x6C};

inline constexpr char kRelyingPartyId[] = "acme.com";
inline constexpr char kAppId[] = "acme.com/";

inline constexpr char kUsername[] = "johnpsmith@example.com";
inline constexpr char kUserDisplayName[] = "John P. Smith";

inline constexpr uint8_t kU2fRegisterCommandApduWithIndividualAttestation[] = {
    // clang-format off
...
inline constexpr uint8_t kU2fRegisterCommandApdu[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instructions
    0x00, 0x01, 0x03, 0x00,
    // Data length in 3 bytes in big endian order.
...
inline constexpr uint8_t kU2fBogusRegisterCommandApdu[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instructions
    0x00, 0x01, 0x03, 0x00,
    // Data length in 3 bytes in big endian order.
...
// https://fidoalliance.org/specs/fido-v2.0-rd-20170927/fido-client-to-authenticator-protocol-v2.0-rd-20170927.html#using-the-ctap2-authenticatormakecredential-command-with-ctap1-u2f-authenticators
inline constexpr uint8_t kU2fSignKeyHandle[] = {
...
inline constexpr uint8_t kU2fSignature[] = {
...
inline constexpr uint8_t kKeyHandleAlpha[] = {0xEA};

inline constexpr uint8_t kKeyHandleBeta[] = {0xEB};

inline constexpr uint8_t kKeyHandleGamma[] = {0xEC};

inline constexpr uint8_t kU2fSignCommandApduWithKeyAlpha[] = {
    // clang-format off
...
inline constexpr uint8_t kU2fSignCommandApduWithKeyAlphaAndBogusChallenge[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order)
...
inline constexpr uint8_t kU2fSignCommandApduWithKeyBeta[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order)
...
inline constexpr uint8_t kU2fSignCommandApduWithKeyBetaAndBogusChallenge[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order)
...
inline constexpr uint8_t kU2fSignCommandApduWithKeyGamma[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order)
...
inline constexpr uint8_t kU2fSignCommandApduWithKeyGammaAndBogusChallenge[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order)
...
inline constexpr uint8_t kU2fSignCommandApdu[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order)
...
// scenarios.
inline constexpr uint8_t kU2fSignCommandWithoutKeyHandle[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instruction parameters
    0x00, 0x02, 0x03, 0x00,
    // Data Length (3 bytes in big endian order).
...
inline constexpr uint8_t kU2fFakeRegisterCommand[] = {
    // clang-format off
    // CLA, INS, P1, P2 APDU instructions
    0x00, 0x01, 0x03, 0x00,
    // Data length in 3 bytes in big endian order.
...
inline constexpr uint8_t kU2fConditionNotSatisfiedApduResponse[] = {0x69, 0x85};

inline constexpr uint8_t kU2fWrongDataApduResponse[] = {0x6A, 0x80};

inline constexpr uint8_t kU2fWrongLengthApduResponse[] = {0x67, 0x00};

inline constexpr uint8_t kU2fKeyHandleSizeApduResponse[] = {0x00, 0x01};

inline constexpr uint8_t kApduEncodedNoErrorRegisterResponse[] = {
    // clang-format off
    // Reserved byte
    0x05,
    // User public key
...
inline constexpr uint8_t kApduEncodedNoErrorSignResponse[] = {
    // clang-format off
    // User presence
    0x01,
    // Sign count(4 bytes)
...
inline constexpr uint8_t kTestU2fRegisterResponse[] = {
    // clang-format off
    // Reserved byte
    0x05,
    // User public key
...
inline constexpr uint8_t kTestECPublicKeyCOSE[] = {
    // clang-format off
    // Map(5)
    0xA5,
    // kty: EC key type
...
inline constexpr uint8_t kU2fAttestationStatementCBOR[] = {
    // clang-format off
    // Map(2)
    0xA2,
    // Text(3)
...
inline constexpr uint8_t kPackedAttestationStatementCBOR[] = {
    // clang-format off
    // Map(3)
    0xA3,
    // Text(3)
...
inline constexpr uint8_t kPackedAttestationStatementCBORNoCerts[] = {
    // clang-format off
    // Map(2)
    0xA2,
    // Text(3)
...
inline constexpr uint8_t kTestU2fSignResponse[] = {
    // clang-format off
    // User presence
    0x01,
    // Sign count(4 bytes)
...
inline constexpr uint8_t kTestSignatureCounter[] = {0x00, 0x00, 0x00, 0x3B};

// The authenticator data for sign responses extracted from above
// |kTestU2fSignResponse|.
inline constexpr uint8_t kTestSignAuthenticatorData[] = {
    // clang-format off
...
inline constexpr uint8_t kTestCorruptedU2fSignResponse[] = {0x01, 0x00, 0x00,
                                                            0x00, 0x90, 0x00};

// CTAP requests ---------------------------------------------------------------
// A MakeCredential request with no RK and no UV.
inline constexpr uint8_t kCtapSimpleMakeCredentialRequest[] = {
    // clang-format off
...
inline constexpr uint8_t kCtapMakeCredentialRequest[] = {
    // clang-format off
    // authenticatorMakeCredential command
    0x01,
    // map(5)
...
inline constexpr uint8_t kTestComplexCtapGetAssertionRequest[] = {
    // clang-format off
...
inline constexpr uint8_t kCtapGetAssertionRequest[] = {
    // clang-format off
    // authenticatorGetAssertion command
    0x02,
    // map(3)
...
inline constexpr uint8_t kCtapSilentGetAssertionRequest[] = {
    // clang-format off
    // authenticatorGetAssertion command
    0x02,
    // map(4)
...
inline constexpr uint8_t kTestAuthenticatorGetInfoResponse[] = {
...
inline constexpr uint8_t kTestCtap2OnlyAuthenticatorGetInfoResponse[] = {
...
// false.
inline constexpr uint8_t kTestGetInfoResponseWithoutUvSupport[] = {
    // clang-format off
    0x00, 0xA6, 0x01, 0x82, 0x68, 0x46, 0x49, 0x44, 0x4F, 0x5F, 0x32, 0x5F,
    0x30, 0x66, 0x55, 0x32, 0x46, 0x5F, 0x56, 0x32, 0x02, 0x82, 0x63, 0x75,
    0x76, 0x6D, 0x6B, 0x68, 0x6D, 0x61, 0x63, 0x2D, 0x73, 0x65, 0x63, 0x72,
...
inline constexpr uint8_t kTestGetInfoResponseWithoutResidentKeySupport[] = {
    // clang-format off
    0x00, 0xA6, 0x01, 0x82, 0x68, 0x46, 0x49, 0x44, 0x4F, 0x5F, 0x32, 0x5F,
    0x30, 0x66, 0x55, 0x32, 0x46, 0x5F, 0x56, 0x32, 0x02, 0x82, 0x63, 0x75,
    0x76, 0x6D, 0x6B, 0x68, 0x6D, 0x61, 0x63, 0x2D, 0x73, 0x65, 0x63, 0x72,
...
// true.
inline constexpr uint8_t kTestGetInfoResponsePlatformDevice[] = {
    // clang-format off
    0x00, 0xA6, 0x01, 0x82, 0x68, 0x46, 0x49, 0x44, 0x4F, 0x5F, 0x32, 0x5F,
    0x30, 0x66, 0x55, 0x32, 0x46, 0x5F, 0x56, 0x32, 0x02, 0x82, 0x63, 0x75,
    0x76, 0x6D, 0x6B, 0x68, 0x6D, 0x61, 0x63, 0x2D, 0x73, 0x65, 0x63, 0x72,
...
inline constexpr uint8_t kTestGetInfoResponseWithClientPinSet[] = {
    // clang-format off
    0x00, 0xA6, 0x01, 0x82, 0x68, 0x46, 0x49, 0x44, 0x4F, 0x5F, 0x32, 0x5F,
    0x30, 0x66, 0x55, 0x32, 0x46, 0x5F, 0x56, 0x32, 0x02, 0x82, 0x63, 0x75,
    0x76, 0x6D, 0x6B, 0x68, 0x6D, 0x61, 0x63, 0x2D, 0x73, 0x65, 0x63, 0x72,
...
inline constexpr uint8_t kTestMakeCredentialResponse[] = {
    // clang-format off
    // Success status byte
    0x00,
    // Map(03)
...
inline constexpr uint8_t kTestMakeCredentialResponseWithIncorrectRpIdHash[] = {
    // clang-format off
...
inline constexpr uint8_t kTestGetAssertionCredentialId[64] = {
    0x3E, 0xBD, 0x89, 0xBF, 0x77, 0xEC, 0x50, 0x97, 0x55, 0xEE, 0x9C,
    0x26, 0x35, 0xEF, 0xAA, 0xAC, 0x7B, 0x2B, 0x9C, 0x5C, 0xEF, 0x17,
    0x36, 0xC3, 0x71, 0x7D, 0xA4, 0x85, 0x34, 0xC8, 0xC6, 0xB6, 0x54,
    0xD7, 0xFF, 0x94, 0x5F, 0x50, 0xB5, 0xCC, 0x4E, 0x78, 0x05, 0x5B,
...
inline constexpr uint8_t kTestGetAssertionResponse[] = {
    // clang-format off
...
inline constexpr uint8_t kTestGetAssertionResponseWithTruncatedUTF8[] = {
...
// 3: h'101112', 4: {"id": h'01020304', "name": "..."}}
inline constexpr uint8_t
    kTestGetAssertionResponseWithTruncatedAndInvalidUTF8[] = {
        0x00, 0xA4, 0x01, 0xA2, 0x62, 0x69, 0x64, 0x58, 0x40, 0x3E, 0xBD, 0x89,
        0xBF, 0x77, 0xEC, 0x50, 0x97, 0x55, 0xEE, 0x9C, 0x26, 0x35, 0xEF, 0xAA,
        0xAC, 0x7B, 0x2B, 0x9C, 0x5C, 0xEF, 0x17, 0x36, 0xC3, 0x71, 0x7D, 0xA4,
        0x85, 0x34, 0xC8, 0xC6, 0xB6, 0x54, 0xD7, 0xFF, 0x94, 0x5F, 0x50, 0xB5,
...
inline constexpr uint8_t kTestGetAssertionResponseWithEmptyCredential[] = {
...
inline constexpr uint8_t kTestGetAssertionResponseWithIncorrectRpIdHash[] = {
    // clang-format off
...
inline constexpr uint8_t kTestGetAssertionResponseWithUserEntity[] = {
    // clang-format off
    0x00, 0xA5, 0x01, 0xA2, 0x62, 0x69, 0x64, 0x58, 0x40, 0x3E, 0xBD, 0x89,
    0xBF, 0x77, 0xEC, 0x50, 0x97, 0x55, 0xEE, 0x9C, 0x26, 0x35, 0xEF, 0xAA,
    0xAC, 0x7B, 0x2B, 0x9C, 0x5C, 0xEF, 0x17, 0x36, 0xC3, 0x71, 0x7D, 0xA4,
    0x85, 0x34, 0xC8, 0xC6, 0xB6, 0x54, 0xD7, 0xFF, 0x94, 0x5F, 0x50, 0xB5,
    0xCC, 0x4E, 0x78, 0x05, 0x5B, 0xDD, 0x39, 0x6B, 0x64, 0xF7, 0x8D, 0xA2,
    ...
    0x70, 0xa5, 0x0d, 0x70, 0xc6, 0x40, 0x7b, 0xcf, 0x01, 0x3d, 0xe9, 0x6d,
    0x4e, 0xfb, 0x17, 0xde,
    // obtained user verification
    0x04,
    0x00, 0x00, 0x00, 0x5F, 0x03, 0x58, 0x46,
    0x30, 0x44, 0x02, 0x20, 0x62, 0xB8, 0xC4, 0x37, 0xB0, 0xB6, 0xFC, 0x89,
    0x37, 0xF6, 0x45, 0xC0, 0x1E, 0x26, 0xCE, 0x0E, 0x26, 0x58, 0x38, 0xFE,
    0xC4, 0xA8, 0x74, 0xC5, 0x5D, 0xDD, 0x6D, 0xEC, 0xF0, 0xA0, 0x83, 0xD3,
    0x02, 0x20, 0x7C, 0xD4, 0x1C, 0xAF, 0x4F, 0xD8, 0x7F, 0x73, 0xBF, 0x01,
...
// https://fidoalliance.org/specs/fido-v2.0-rd-20170927/fido-client-to-authenticator-protocol-v2.0-rd-20170927.html
inline constexpr uint8_t kCtap2MakeCredentialCertificate[] = {
...
inline constexpr uint8_t kCtap2MakeCredentialAuthData[] = {
    // clang-format off
    // RP ID hash
    0x11, 0x94, 0x22, 0x8D, 0xA8, 0xFD, 0xBD, 0xEE, 0xFD, 0x26, 0x1B, 0xD7,
    0xB6, 0x59, 0x5C, 0xFD, 0x70, 0xA5, 0x0D, 0x70, 0xC6, 0x40, 0x7B, 0xCF,
...
inline constexpr uint8_t kCtap2MakeCredentialSignature[] = {
    0x30, 0x45, 0x02, 0x20, 0x13, 0xf7, 0x3c, 0x5d, 0x9d, 0x53, 0x0e, 0x8c,
    0xc1, 0x5c, 0xc9, 0xbd, 0x96, 0xad, 0x58, 0x6d, 0x39, 0x36, 0x64, 0xe4,
    0x62, 0xd5, 0xf0, 0x56, 0x12, 0x35, 0xe6, 0x35, 0x0f, 0x2b, 0x72, 0x89,
    0x02, 0x21, 0x00, 0x90, 0x35, 0x7f, 0xf9, 0x10, 0xcc, 0xb5, 0x6a, 0xc5,
...
inline constexpr uint8_t kCtap2MakeCredentialCredentialId[] = {
    0x89, 0x59, 0xce, 0xad, 0x5b, 0x5c, 0x48, 0x16,
    0x4e, 0x8a, 0xbc, 0xd6, 0xd9, 0x43, 0x5c, 0x6f,
};

inline constexpr uint8_t kNoneAttestationResponse[] = {
    // clang-format off
    // map(3)
    0xa3,
    // Format - text(3)
...
inline constexpr uint8_t kCtap2GetAssertionAuthData[] = {
...
inline constexpr uint8_t kCtap2GetAssertionSignature[] = {
...
inline constexpr uint8_t kDeviceGetAssertionResponse[] = {
    // clang-format off
...
inline constexpr uint8_t kX962UncompressedPublicKey[] = {
    // clang-format off
    0x04,
    // X-coordinate
    0xE8, 0x76, 0x25, 0x89, 0x6E, 0xE4, 0xE4, 0x6D, 0xC0, 0x32, 0x76, 0x6E,
