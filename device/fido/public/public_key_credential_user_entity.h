...
#ifndef DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_USER_ENTITY_H_
#define DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_USER_ENTITY_H_
...
// request.
class COMPONENT_EXPORT(FIDO_PUBLIC) PublicKeyCredentialUserEntity {
 public:
...
#endif  // DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_USER_ENTITY_H_
