...
#ifndef DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_PARAMS_H_
#define DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_PARAMS_H_
...
class COMPONENT_EXPORT(FIDO_PUBLIC) PublicKeyCredentialParams {
 public:
  struct COMPONENT_EXPORT(FIDO_PUBLIC) CredentialInfo {
...
#endif  // DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_PARAMS_H_
