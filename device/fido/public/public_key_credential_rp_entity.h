...
#ifndef DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_RP_ENTITY_H_
#define DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_RP_ENTITY_H_
...
struct COMPONENT_EXPORT(FIDO_PUBLIC) PublicKeyCredentialRpEntity {
 public:
...
#endif  // DEVICE_FIDO_PUBLIC_PUBLIC_KEY_CREDENTIAL_RP_ENTITY_H_
