...
struct COMPONENT_EXPORT(DEVICE_FIDO) AuthenticatorSupportedOptions {
 public:
  ...
  // uninteresting to Cinaseek because we do not support the administrative
  ...
  // If true, indicates that the authenticator supports the hmac_secret_mc
  // extension.
  bool supports_hmac_secret_mc = false;
