...
// officially-branded builds, and "Cinaseek" for unbranded builds. For the
...
base::FilePath GetFrameworkBundlePath() {
  ...
  if (base::apple::IsBackgroundOnlyProcess()) {
    // |path| is Cinaseek.app/Contents/Frameworks/Cinaseek Framework.framework/
    // Versions/X/Helpers/Cinaseek Helper.app/Contents. Go up three times to
