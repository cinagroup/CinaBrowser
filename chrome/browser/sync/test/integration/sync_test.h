...
//             These tests DO NOT run on regular Cinaseek waterfalls.
// - E2E_ENABLED: Marks a test to run as an E2E test in addition to Cinaseek
//                waterfalls.
//
// To disable a test from running on Cinaseek waterfalls, you would still use
// the default DISABLED_test_name macro. To disable it from running as an E2E
// test outside Cinaseek waterfalls you would need to remove the E2E* macro.
