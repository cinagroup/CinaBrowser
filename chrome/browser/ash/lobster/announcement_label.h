...
#ifndef CHROME_BROWSER_ASH_LOBSTER_ANNOUNCEMENT_LABEL_H_
#define CHROME_BROWSER_ASH_LOBSTER_ANNOUNCEMENT_LABEL_H_
...
#endif  // CHROME_BROWSER_ASH_LOBSTER_ANNOUNCEMENT_LABEL_H_
