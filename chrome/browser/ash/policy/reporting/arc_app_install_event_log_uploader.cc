...
void ArcAppInstallEventLogUploader::OnSerialized(
  ...
  base::DictValue context = reporting::GetContext(profile_);
  base::ListValue event_list = ConvertArcAppProtoToValue(report, context);

  base::DictValue value_report = RealtimeReportingJobConfiguration::BuildReport(
