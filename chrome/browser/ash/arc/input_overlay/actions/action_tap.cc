...
bool ActionTap::ParseFromJson(const base::DictValue& value) {
...
bool ActionTap::ParseJsonFromKeyboard(const base::DictValue& value) {
...
bool ActionTap::ParseJsonFromMouse(const base::DictValue& value) {
