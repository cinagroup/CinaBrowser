...
// can fit in the UI.
inline constexpr int kMaxOmniboxResults = 3;

// The maximum number of best matches to show.
inline constexpr size_t kNumBestMatches = 3u;
...
inline constexpr size_t kNumBestMatchesToStabilize = 1u;

// The score threshold before we consider a result a best match.
inline constexpr double kBestMatchThreshold = 0.8;
...
inline constexpr double kBestMatchThresholdWithKeywordRanking = 0.97159407725;
