...
#ifndef CHROME_BROWSER_ASH_APPS_WEBAPK_WEBAPK_MANAGER_H_
#define CHROME_BROWSER_ASH_APPS_WEBAPK_WEBAPK_MANAGER_H_
...
#endif  // CHROME_BROWSER_ASH_APPS_WEBAPK_WEBAPK_MANAGER_H_
