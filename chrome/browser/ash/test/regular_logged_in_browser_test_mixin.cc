...
RegularLoggedInBrowserTestMixin::RegularLoggedInBrowserTestMixin(
...
RegularLoggedInBrowserTestMixin::~RegularLoggedInBrowserTestMixin() = default;

void RegularLoggedInBrowserTestMixin::SetUpCommandLine(
...
void RegularLoggedInBrowserTestMixin::SetUpLocalStatePrefService(
    PrefService* local_state) {
  user_manager::TestHelper::RegisterPersistedUser(*local_state, account_id_);
}
