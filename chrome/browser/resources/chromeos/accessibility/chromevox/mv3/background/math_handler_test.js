 ...
 */
ChromeVoxMV3MathHandlerTest = class extends ChromeVoxE2ETest {
  /** @override */
  async setUpDeferred() {
...
AX_TEST_F(
    'ChromeVoxMV3MathHandlerTest', 'noMathRootInMathContent', async function() {
...
AX_TEST_F(
    'ChromeVoxMV3MathHandlerTest', 'mathRootInMathContent', async function() {
      const mockFeedback = this.createMockFeedback();
      const math = this.createMockNode({
        role: chrome.automation.RoleType.MathMlMath,
...
AX_TEST_F(
    'ChromeVoxMV3MathHandlerTest', 'mathRootDoesntMatchRegexInMathContent',
    async function() {
      const mockFeedback = this.createMockFeedback();
      const math = this.createMockNode({
        role: chrome.automation.RoleType.MathMlMath,
