...
#ifndef CHROME_BROWSER_AUTOFILL_ANDROID_AUTOFILL_PROFILE_BRIDGE_H_
#define CHROME_BROWSER_AUTOFILL_ANDROID_AUTOFILL_PROFILE_BRIDGE_H_
...
#endif  // CHROME_BROWSER_AUTOFILL_ANDROID_AUTOFILL_PROFILE_BRIDGE_H_
