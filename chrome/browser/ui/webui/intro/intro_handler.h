...
class IntroHandler : public content::WebUIMessageHandler {
 ...
 private:
  ...
  // Chrome.
  void HandleContinueWithAccount(const base::ListValue& args);
  ...
  void HandleInitializeMainView(const base::ListValue& args);
  ...
  // default browser.
  void HandleSkipDefaultBrowser(const base::ListValue& args);
