...
enum class CustomizedShortcutSettings {
  ...
  CUSTOMIZED_SHORTCUT_SETTINGS_ENTERPRISE_SHORTCUTS = 3,
  CUSTOMIZED_SHORTCUT_SETTINGS_ENTERPRISE_SHORTCUTS_AND_MOST_VISITED = 4,
  CUSTOMIZED_SHORTCUT_SETTINGS_ENTERPRISE_SHORTCUTS_AND_CUSTOM_LINKS = 5,

  kMaxValue = CUSTOMIZED_SHORTCUT_SETTINGS_ENTERPRISE_SHORTCUTS_AND_CUSTOM_LINKS
};
...
enum class CustomizeShortcutAction {
  ...
  CUSTOMIZE_PERSONAL_SHORTCUT_ACTION_TOGGLE_VISIBILITY = 9,
  CUSTOMIZE_ENTERPRISE_SHORTCUT_ACTION_TOGGLE_VISIBILITY = 10,
  CUSTOMIZE_ENTERPRISE_SHORTCUT_ACTION_REMOVE = 11,
  CUSTOMIZE_ENTERPRISE_SHORTCUT_ACTION_UNDO = 12,
  CUSTOMIZE_ENTERPRISE_SHORTCUT_ACTION_RESTORE_ALL = 13,
  CUSTOMIZE_ENTERPRISE_SHORTCUT_ACTION_UPDATE = 14,
  CUSTOMIZE_SHORTCUT_ACTION_AUTO_REMOVE = 15,
  CUSTOMIZE_SHORTCUT_ACTION_AUTO_REMOVE_UNDO = 16,

  kMaxValue = CUSTOMIZE_SHORTCUT_ACTION_AUTO_REMOVE_UNDO
};
