...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kBookmarkEditorId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kBookmarkEditorOkButtonId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kBrowserDialogAnchorElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kExtensionsMenuSiteSettingsToggleElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kExtensionsMenuReloadPageButtonElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kExtensionsMenuReloadSectionElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kFederationElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kFindPageActionElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kProjectsPanelButtonElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kProjectsPanelControlsViewElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kProjectsPanelNewTabGroupButtonElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kProjectsPanelRecentThreadsViewElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kProjectsPanelTabGroupsItemViewElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kProjectsPanelTabGroupsListTitleElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kSidePanelResizeAreaElementId);
DEFINE_ELEMENT_IDENTIFIER_VALUE(kSidePanelResizeHandleElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kUnfocusTabGroupButtonElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kVerticalTabStripProjectsButtonElementId);
...
DEFINE_ELEMENT_IDENTIFIER_VALUE(kWebUIToolbarElementIdentifier);
