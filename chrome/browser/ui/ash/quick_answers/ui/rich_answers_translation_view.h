...
#ifndef CHROME_BROWSER_UI_ASH_QUICK_ANSWERS_UI_RICH_ANSWERS_TRANSLATION_VIEW_H_
#define CHROME_BROWSER_UI_ASH_QUICK_ANSWERS_UI_RICH_ANSWERS_TRANSLATION_VIEW_H_
...
#endif  // CHROME_BROWSER_UI_ASH_QUICK_ANSWERS_UI_RICH_ANSWERS_TRANSLATION_VIEW_H_
