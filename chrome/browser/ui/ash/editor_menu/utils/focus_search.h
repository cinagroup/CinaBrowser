...
#ifndef CHROME_BROWSER_UI_ASH_EDITOR_MENU_UTILS_FOCUS_SEARCH_H_
#define CHROME_BROWSER_UI_ASH_EDITOR_MENU_UTILS_FOCUS_SEARCH_H_
...
#endif  // CHROME_BROWSER_UI_ASH_EDITOR_MENU_UTILS_FOCUS_SEARCH_H_
