...
#ifndef CHROME_BROWSER_UI_ASH_EDITOR_MENU_EDITOR_MENU_CHIP_VIEW_H_
#define CHROME_BROWSER_UI_ASH_EDITOR_MENU_EDITOR_MENU_CHIP_VIEW_H_
...
#endif  // CHROME_BROWSER_UI_ASH_EDITOR_MENU_EDITOR_MENU_CHIP_VIEW_H_
