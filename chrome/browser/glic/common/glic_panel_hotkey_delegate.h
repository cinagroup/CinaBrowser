...
#ifndef CHROME_BROWSER_GLIC_COMMON_GLIC_PANEL_HOTKEY_DELEGATE_H_
#define CHROME_BROWSER_GLIC_COMMON_GLIC_PANEL_HOTKEY_DELEGATE_H_
...
#endif  // CHROME_BROWSER_GLIC_COMMON_GLIC_PANEL_HOTKEY_DELEGATE_H_
