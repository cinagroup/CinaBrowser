...
#ifndef CHROME_BROWSER_DESKTOP_TO_MOBILE_PROMOS_PROMOS_UTILS_H_
#define CHROME_BROWSER_DESKTOP_TO_MOBILE_PROMOS_PROMOS_UTILS_H_
...
#endif  // CHROME_BROWSER_DESKTOP_TO_MOBILE_PROMOS_PROMOS_UTILS_H_
