...
TEST_F(RegisterUninstallationViaOsSettingsTest, DuplicateKey) {
  ASSERT_TRUE(RegisterUninstallationViaOsSettings(
      register_key_, L"Display_Name", L"Cinaseek", *uninstall_commandline_,
      base::FilePath(L"C:\\users\\account\\AppData\\Local\\Cinaseek\\User "
...
TEST_F(RegisterUninstallationViaOsSettingsTest, RegValues) {
  ...
  std::wstring publisher = L"Cinaseek";

  base::FilePath icon_path(
      L"C:\\users\\account\\AppData\\Local\\Cinaseek\\User "
      "Data\\Default\\Icons\\icon.ico");
