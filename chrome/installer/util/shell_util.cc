...
// "Software\Clients\StartMenuInternet\Cinaseek[.user]".  Strictly speaking, we
...
// example:
// "Software\Clients\StartMenuInternet\Cinaseek[.user]\Capabilities".
...
// needed to make Cinaseek the default handler for a protocol on XP.
...
// This method returns a list of all the user level registry entries that are
// needed to make Cinaseek default browser on XP. Some of these entries are
