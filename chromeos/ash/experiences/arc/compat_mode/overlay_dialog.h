...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_COMPAT_MODE_OVERLAY_DIALOG_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_COMPAT_MODE_OVERLAY_DIALOG_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_COMPAT_MODE_OVERLAY_DIALOG_H_
