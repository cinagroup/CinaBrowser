...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_ARC_INTENT_HELPER_MOJO_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_ARC_INTENT_HELPER_MOJO_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_ARC_INTENT_HELPER_MOJO_H_
