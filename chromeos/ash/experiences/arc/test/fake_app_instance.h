...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_APP_INSTANCE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_APP_INSTANCE_H_
...
class FakeAppInstance : public mojom::AppInstance {
 public:
  ...
  void set_app_category_of_pkg(std::string_view pkg_name,
                               mojom::AppCategory category) {
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_APP_INSTANCE_H_
