...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_BLUETOOTH_INSTANCE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_BLUETOOTH_INSTANCE_H_
...
class FakeBluetoothInstance : public mojom::BluetoothInstance {
 public:
  ...
  bool get_service_changed_flag() { return service_changed_flag_; }

  void reset_service_changed_flag() { service_changed_flag_ = false; }
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_TEST_FAKE_BLUETOOTH_INSTANCE_H_
