...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_TEST_ARC_UTIL_TEST_SUPPORT_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_TEST_ARC_UTIL_TEST_SUPPORT_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_TEST_ARC_UTIL_TEST_SUPPORT_H_
