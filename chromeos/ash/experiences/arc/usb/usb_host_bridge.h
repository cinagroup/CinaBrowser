...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_USB_USB_HOST_BRIDGE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_USB_USB_HOST_BRIDGE_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_USB_USB_HOST_BRIDGE_H_
