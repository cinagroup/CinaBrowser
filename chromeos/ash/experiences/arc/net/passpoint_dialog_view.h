...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_NET_PASSPOINT_DIALOG_VIEW_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_NET_PASSPOINT_DIALOG_VIEW_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_NET_PASSPOINT_DIALOG_VIEW_H_
