...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_NET_ALWAYS_ON_VPN_MANAGER_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_NET_ALWAYS_ON_VPN_MANAGER_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_NET_ALWAYS_ON_VPN_MANAGER_H_
