...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_PAY_ARC_PAYMENT_APP_BRIDGE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_PAY_ARC_PAYMENT_APP_BRIDGE_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_PAY_ARC_PAYMENT_APP_BRIDGE_H_
