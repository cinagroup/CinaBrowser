...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_CONNECTION_NOTIFIER_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_CONNECTION_NOTIFIER_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_SESSION_CONNECTION_NOTIFIER_H_
