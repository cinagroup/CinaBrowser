...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_TIMER_ARC_TIMER_BRIDGE_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_TIMER_ARC_TIMER_BRIDGE_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_TIMER_ARC_TIMER_BRIDGE_H_
