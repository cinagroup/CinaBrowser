...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_ARC_INTENT_HELPER_OBSERVER_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_ARC_INTENT_HELPER_OBSERVER_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_ARC_INTENT_HELPER_OBSERVER_H_
