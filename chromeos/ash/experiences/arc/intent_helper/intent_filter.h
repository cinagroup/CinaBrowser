...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_INTENT_FILTER_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_INTENT_FILTER_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_INTENT_FILTER_H_
