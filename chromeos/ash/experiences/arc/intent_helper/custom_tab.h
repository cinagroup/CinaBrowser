...
#ifndef CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_CUSTOM_TAB_H_
#define CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_CUSTOM_TAB_H_
...
#endif  // CHROMEOS_ASH_EXPERIENCES_ARC_INTENT_HELPER_CUSTOM_TAB_H_
