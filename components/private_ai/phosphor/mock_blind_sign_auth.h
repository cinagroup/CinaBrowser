...
#ifndef COMPONENTS_PRIVATE_AI_PHOSPHOR_MOCK_BLIND_SIGN_AUTH_H_
#define COMPONENTS_PRIVATE_AI_PHOSPHOR_MOCK_BLIND_SIGN_AUTH_H_
...
#endif  // COMPONENTS_PRIVATE_AI_PHOSPHOR_MOCK_BLIND_SIGN_AUTH_H_
