...
using ResourceMap = absl::flat_hash_map<
    std::string,
...
using ElementMap =
    absl::flat_hash_map<std::string, std::unique_ptr<HTMLElement>>;
...
using KeyToFrameTreeIdMap =
    absl::flat_hash_map<std::string, content::FrameTreeNodeId>;
...
using FrameTreeIdToChildIdsMap =
    absl::flat_hash_map<content::FrameTreeNodeId, absl::flat_hash_set<int>>;
