...
// LINT.IfChange(SecurityReportTrigger)
enum class SecurityReportTrigger {
  kTimer = 0,
  kCookieChange = 1,
  kPolicyChange = 2,
  kMaxValue = kPolicyChange
};
// LINT.ThenChange(//tools/metrics/histograms/metadata/enterprise/enums.xml:SecurityReportTrigger)
