...
#include "components/autofill/core/browser/payments/payments_requests/update_bnpl_payment_instrument_request_test_api.h"
...
class UpdateBnplPaymentInstrumentRequestTest : public testing::Test {
 public:
  void SetUp() override {
    ...
    request_ = std::make_unique<UpdateBnplPaymentInstrumentRequest>(
 ...
 private:
  std::unique_ptr<UpdateBnplPaymentInstrumentRequest> request_;
};
