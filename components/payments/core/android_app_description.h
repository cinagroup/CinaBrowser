...
// Describes an Android activity with org.Cinaseek.intent.action.PAY intent
...
struct AndroidActivityDescription {
  ...
  // "org.Cinaseek.default_payment_method_name" metadata value of this activity.
  // For example, "https://example.com/web-pay".
  //
  // The metadata value of "org.Cinaseek.payment_method_names" is not yet used
...
struct AndroidAppDescription {
  ...
  // The list of activities with org.Cinaseek.intent.action.PAY intent filters
  // in this app.
  std::vector<std::unique_ptr<AndroidActivityDescription>> activities;

  // The list of service names with org.Cinaseek.intent.action.IS_READY_TO_PAY
