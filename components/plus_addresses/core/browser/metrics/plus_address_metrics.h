...
#ifndef COMPONENTS_PLUS_ADDRESSES_CORE_BROWSER_METRICS_PLUS_ADDRESS_METRICS_H_
#define COMPONENTS_PLUS_ADDRESSES_CORE_BROWSER_METRICS_PLUS_ADDRESS_METRICS_H_
...
#endif  // COMPONENTS_PLUS_ADDRESSES_CORE_BROWSER_METRICS_PLUS_ADDRESS_METRICS_H_
