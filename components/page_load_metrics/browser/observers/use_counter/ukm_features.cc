...
UseCounterMetricsRecorder::GetAllowedUkmFeatures() {
  static base::NoDestructor<UseCounterMetricsRecorder::UkmFeatureList>
      ...
      opt_in_features(std::initializer_list<WebFeature>({
          ...
          WebFeature::kProofreader_Availability,
