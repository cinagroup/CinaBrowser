...
struct PredictionRequestFeatures {
  // Do not delete / modify enum assignments, as they will be interpreted on the
  // server side and should be backwards compatible!
  ...
  ExperimentId experiment_id = ExperimentId::kNoExperimentId;

  // The permission request relevance generated by the AI on-device model.
