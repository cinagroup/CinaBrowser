                ...
                content::PermissionDescriptorUtil::
                    CreatePermissionDescriptorForPermissionType(
                        PermissionUtil::ContentSettingsTypeToPermissionType(
                            content_settings_type)),
                /*render_frame_host=*/nullptr, insecure_url, insecure_url)
            .status);
    EXPECT_EQ(
        PermissionStatus::DENIED,
        permission_context
            .GetPermissionStatus(
                content::PermissionDescriptorUtil::
                    CreatePermissionDescriptorForPermissionType(
                        PermissionUtil::ContentSettingsTypeToPermissionType(
                            content_settings_type)),
                /*render_frame_host=*/nullptr, insecure_url, secure_url)
            .status);
  }
}
  ...
  EXPECT_EQ(
      ...
      permission_context
          .GetPermissionStatus(content::PermissionDescriptorUtil::
                                   CreatePermissionDescriptorForPermissionType(
                                       blink::PermissionType::WAKE_LOCK_SCREEN),
...
TEST_F(WakeLockPermissionContextTests, TestSystemLockPermissionRequest) {
  ...
  EXPECT_EQ(
      ...
      permission_context
          .GetPermissionStatus(content::PermissionDescriptorUtil::
                                   CreatePermissionDescriptorForPermissionType(
                                       blink::PermissionType::WAKE_LOCK_SYSTEM),
                               /*render_frame_host=*/nullptr, url, url)
          .status);
}
