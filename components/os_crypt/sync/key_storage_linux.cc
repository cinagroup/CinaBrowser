...
#else
const char KeyStorageLinux::kFolderName[] = "Cinaseek Keys";
const char KeyStorageLinux::kKey[] = "Cinaseek Safe Storage";
#endif
...
#else
  static const base::NoDestructor<std::string> kDefaultApplicationName("Cinaseek");
#endif
