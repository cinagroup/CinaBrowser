...
#ifndef COMPONENTS_POLICY_CORE_BROWSER_URL_LIST_URL_BLOCKLIST_MANAGER_H_
#define COMPONENTS_POLICY_CORE_BROWSER_URL_LIST_URL_BLOCKLIST_MANAGER_H_
...
#endif  // COMPONENTS_POLICY_CORE_BROWSER_URL_LIST_URL_BLOCKLIST_MANAGER_H_
