...
#ifndef COMPONENTS_POLICY_CORE_BROWSER_URL_LIST_URL_SCHEME_LIST_POLICY_HANDLER_H_
#define COMPONENTS_POLICY_CORE_BROWSER_URL_LIST_URL_SCHEME_LIST_POLICY_HANDLER_H_
...
#endif  // COMPONENTS_POLICY_CORE_BROWSER_URL_LIST_URL_SCHEME_LIST_POLICY_HANDLER_H_
