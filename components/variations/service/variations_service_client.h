...
class VariationsServiceClient {
 public:
  ...
  //   Cinaseek consider all such devices as non-enterprise.
  // - For mac and chromeOS, they are inconsistent because UMA does not consider
  //   any such devices as enterprise, but Cinaseek does.
  // - For windows, both consider some clients as enterprise, but use different
  //   Cinaseek doesn't use brand_code so they may have inconsistent results.
