...
export function parse(data) {
  ...
  try {
    ...
    // Deserialization is never expected to fail in Cinaseek,
 ...
 * https://source.Cinaseek.org/Cinaseek/Cinaseek/src/+/main:components/variations/proto/client_variations.proto;l=14-22
 *
 * @param {{
 *   variationIds: !Array<number>,
 *   triggerVariationIds: !Array<number>,
