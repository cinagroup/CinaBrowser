...
#ifndef COMPONENTS_OPTIMIZATION_GUIDE_CORE_HINTS_HINT_CACHE_H_
#define COMPONENTS_OPTIMIZATION_GUIDE_CORE_HINTS_HINT_CACHE_H_
...
#endif  // COMPONENTS_OPTIMIZATION_GUIDE_CORE_HINTS_HINT_CACHE_H_
