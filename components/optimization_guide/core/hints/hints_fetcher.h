...
#ifndef COMPONENTS_OPTIMIZATION_GUIDE_CORE_HINTS_HINTS_FETCHER_H_
#define COMPONENTS_OPTIMIZATION_GUIDE_CORE_HINTS_HINTS_FETCHER_H_
...
#endif  // COMPONENTS_OPTIMIZATION_GUIDE_CORE_HINTS_HINTS_FETCHER_H_
