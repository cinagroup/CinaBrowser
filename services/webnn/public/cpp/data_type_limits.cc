...
DataTypeLimits::DataTypeLimits(SupportedTensors input,
    ...
    : input(input),
      ...
      is_nan_input(is_nan_input),
      is_infinite_input(is_infinite_input),
      ...
      round_even_input(round_even_input),
      ...
      gru_input(gru_input),
      gru_bias(gru_bias),
      gru_output_sequence(gru_output_sequence),
      ...
      lstm_bias(lstm_bias),
      lstm_output_sequence(lstm_output_sequence),
