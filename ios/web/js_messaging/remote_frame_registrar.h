...
#ifndef IOS_WEB_JS_MESSAGING_REMOTE_FRAME_REGISTRAR_H_
#define IOS_WEB_JS_MESSAGING_REMOTE_FRAME_REGISTRAR_H_
...
#endif  // IOS_WEB_JS_MESSAGING_REMOTE_FRAME_REGISTRAR_H_
