...
#ifndef IOS_CHROME_COMMON_UI_INSTRUCTION_VIEW_INSTRUCTION_VIEW_H_
#define IOS_CHROME_COMMON_UI_INSTRUCTION_VIEW_INSTRUCTION_VIEW_H_
...
#endif  // IOS_CHROME_COMMON_UI_INSTRUCTION_VIEW_INSTRUCTION_VIEW_H_
