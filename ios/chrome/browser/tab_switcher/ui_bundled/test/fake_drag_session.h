...
#ifndef IOS_CHROME_BROWSER_TAB_SWITCHER_UI_BUNDLED_TEST_FAKE_DRAG_SESSION_H_
#define IOS_CHROME_BROWSER_TAB_SWITCHER_UI_BUNDLED_TEST_FAKE_DRAG_SESSION_H_
...
#endif  // IOS_CHROME_BROWSER_TAB_SWITCHER_UI_BUNDLED_TEST_FAKE_DRAG_SESSION_H_
