...
#ifndef IOS_CHROME_BROWSER_DOWNLOAD_UI_RADIAL_PROGRESS_VIEW_H_
#define IOS_CHROME_BROWSER_DOWNLOAD_UI_RADIAL_PROGRESS_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_DOWNLOAD_UI_RADIAL_PROGRESS_VIEW_H_
