...
PasswordCounterDelegateBridge::PasswordCounterDelegateBridge(
    ...
    : observer_(observer), counter_(profile_store, account_store) {
  counter_observation_.Observe(&counter_);
}

PasswordCounterDelegateBridge::~PasswordCounterDelegateBridge() = default;

void PasswordCounterDelegateBridge::OnPasswordCounterChanged() {
  [observer_ passwordCounterChanged:(counter_.autofillable_passwords())];
}
