...
#ifndef IOS_CHROME_BROWSER_SHARING_UI_BUNDLED_SHARING_SCENARIO_H_
#define IOS_CHROME_BROWSER_SHARING_UI_BUNDLED_SHARING_SCENARIO_H_
...
#endif  // IOS_CHROME_BROWSER_SHARING_UI_BUNDLED_SHARING_SCENARIO_H_
