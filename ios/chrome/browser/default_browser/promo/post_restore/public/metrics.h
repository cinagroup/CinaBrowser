...
#ifndef IOS_CHROME_BROWSER_DEFAULT_BROWSER_PROMO_POST_RESTORE_PUBLIC_METRICS_H_
#define IOS_CHROME_BROWSER_DEFAULT_BROWSER_PROMO_POST_RESTORE_PUBLIC_METRICS_H_
...
#endif  // IOS_CHROME_BROWSER_DEFAULT_BROWSER_PROMO_POST_RESTORE_PUBLIC_METRICS_H_
