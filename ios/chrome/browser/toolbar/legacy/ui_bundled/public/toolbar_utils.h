...
#ifndef IOS_CHROME_BROWSER_TOOLBAR_LEGACY_UI_BUNDLED_PUBLIC_TOOLBAR_UTILS_H_
#define IOS_CHROME_BROWSER_TOOLBAR_LEGACY_UI_BUNDLED_PUBLIC_TOOLBAR_UTILS_H_
...
#endif  // IOS_CHROME_BROWSER_TOOLBAR_LEGACY_UI_BUNDLED_PUBLIC_TOOLBAR_UTILS_H_
