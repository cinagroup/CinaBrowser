...
#ifndef IOS_CHROME_BROWSER_POPUP_MENU_PUBLIC_POPUP_MENU_UI_UPDATING_H_
#define IOS_CHROME_BROWSER_POPUP_MENU_PUBLIC_POPUP_MENU_UI_UPDATING_H_
...
#endif  // IOS_CHROME_BROWSER_POPUP_MENU_PUBLIC_POPUP_MENU_UI_UPDATING_H_
