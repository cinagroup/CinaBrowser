...
#ifndef IOS_CHROME_BROWSER_CONTENT_SUGGESTIONS_MAGIC_STACK_PUBLIC_MAGIC_STACK_UTILS_H_
#define IOS_CHROME_BROWSER_CONTENT_SUGGESTIONS_MAGIC_STACK_PUBLIC_MAGIC_STACK_UTILS_H_
