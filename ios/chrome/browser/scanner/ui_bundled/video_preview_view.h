...
#ifndef IOS_CHROME_BROWSER_SCANNER_UI_BUNDLED_VIDEO_PREVIEW_VIEW_H_
#define IOS_CHROME_BROWSER_SCANNER_UI_BUNDLED_VIDEO_PREVIEW_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_SCANNER_UI_BUNDLED_VIDEO_PREVIEW_VIEW_H_
