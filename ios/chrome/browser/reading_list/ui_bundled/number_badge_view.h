...
#ifndef IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_NUMBER_BADGE_VIEW_H_
#define IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_NUMBER_BADGE_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_NUMBER_BADGE_VIEW_H_
