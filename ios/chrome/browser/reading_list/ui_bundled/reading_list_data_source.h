...
#ifndef IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_READING_LIST_DATA_SOURCE_H_
#define IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_READING_LIST_DATA_SOURCE_H_
...
- (void)fillReadItems:
            (nullable NSMutableArray<id<ReadingListListItem>>*)readArray
          unreadItems:
              (nullable NSMutableArray<id<ReadingListListItem>>*)unreadArray;
...
#endif  // IOS_CHROME_BROWSER_READING_LIST_UI_BUNDLED_READING_LIST_DATA_SOURCE_H_
