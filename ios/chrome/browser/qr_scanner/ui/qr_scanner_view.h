...
#ifndef IOS_CHROME_BROWSER_QR_SCANNER_UI_QR_SCANNER_VIEW_H_
#define IOS_CHROME_BROWSER_QR_SCANNER_UI_QR_SCANNER_VIEW_H_
...
#endif  // IOS_CHROME_BROWSER_QR_SCANNER_UI_QR_SCANNER_VIEW_H_
