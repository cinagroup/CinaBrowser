...
#ifndef IOS_CHROME_BROWSER_HISTORY_UI_BUNDLED_BRIDGE_HEADER_H_
#define IOS_CHROME_BROWSER_HISTORY_UI_BUNDLED_BRIDGE_HEADER_H_
...
#endif  // IOS_CHROME_BROWSER_HISTORY_UI_BUNDLED_BRIDGE_HEADER_H_
