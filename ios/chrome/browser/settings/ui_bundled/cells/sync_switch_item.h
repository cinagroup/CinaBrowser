...
#ifndef IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_CELLS_SYNC_SWITCH_ITEM_H_
#define IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_CELLS_SYNC_SWITCH_ITEM_H_
...
#endif  // IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_CELLS_SYNC_SWITCH_ITEM_H_
