...
#ifndef IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_PASSWORD_PASSWORDS_IN_OTHER_APPS_CONSTANTS_H_
#define IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_PASSWORD_PASSWORDS_IN_OTHER_APPS_CONSTANTS_H_
...
// A11y identifier for the caption that explains how to turn off autofill in
// other apps.
extern NSString* const
    kPasswordsInOtherAppsTurnOffCaptionAccessibilityIdentifier;

#endif  // IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_PASSWORD_PASSWORDS_IN_OTHER_APPS_CONSTANTS_H_
