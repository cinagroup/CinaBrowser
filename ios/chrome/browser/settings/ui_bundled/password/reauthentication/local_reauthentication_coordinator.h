...
#ifndef IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_PASSWORD_REAUTHENTICATION_LOCAL_REAUTHENTICATION_COORDINATOR_H_
#define IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_PASSWORD_REAUTHENTICATION_LOCAL_REAUTHENTICATION_COORDINATOR_H_
...
// LocalReauthenticationViewController is popped from the navigation
// controller.
...
// Authentication (Face Id, Touch Id or Passcode). Do not confuse this with
// SigninReauthCoordinator which reauthenticate the SystemIdentity with the
...
@interface LocalReauthenticationCoordinator : ChromeCoordinator

@property(nonatomic, weak) id<LocalReauthenticationCoordinatorDelegate>
    delegate;
...
#endif  // IOS_CHROME_BROWSER_SETTINGS_UI_BUNDLED_PASSWORD_REAUTHENTICATION_LOCAL_REAUTHENTICATION_COORDINATOR_H_
