...
#ifndef IOS_CHROME_BROWSER_FIRST_RUN_TEST_FIRST_RUN_APP_INTERFACE_H_
#define IOS_CHROME_BROWSER_FIRST_RUN_TEST_FIRST_RUN_APP_INTERFACE_H_
...
#endif  // IOS_CHROME_BROWSER_FIRST_RUN_TEST_FIRST_RUN_APP_INTERFACE_H_
