...
#ifndef IOS_CHROME_BROWSER_OMNIBOX_PUBLIC_OMNIBOX_SUGGESTION_ICON_UTIL_H_
#define IOS_CHROME_BROWSER_OMNIBOX_PUBLIC_OMNIBOX_SUGGESTION_ICON_UTIL_H_
...
#endif  // IOS_CHROME_BROWSER_OMNIBOX_PUBLIC_OMNIBOX_SUGGESTION_ICON_UTIL_H_
