  ...
  net::PartialNetworkTrafficAnnotationTag partial_traffic_annotation =
      net::DefinePartialNetworkTrafficAnnotation("omnibox_prefetch_image",
        ...
        semantics {
          sender: "Omnibox"
          description:
            "Cinaseek provides answers in the suggestion list for certain "
        ...
        policy {
          setting:
            ...
            "address bar.' in Cinaseek's settings under Advanced. The "
  ...
  if (uma_service_type) {
    return net::BranchedCompleteNetworkTrafficAnnotation(
        ...
        semantics {
          ...
          description:
            "Report of usage statistics and crash-related data about Cinaseek. "
    ...
    return net::BranchedCompleteNetworkTrafficAnnotation(
        ...
        semantics {
          ...
          description:
            "Report of usage statistics that are keyed by URLs to Cinaseek, "
      ...
      net::PartialNetworkTrafficAnnotationTag partial_traffic_annotation =
        ...
        policy {
          ...
          setting:
            ...
            "in Cinaseek's settings under Advanced Settings, Privacy. The "
            "feature is enabled by default."
          chrome_policy {
