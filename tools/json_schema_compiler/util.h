...
void AddItemToList(const base::DictValue& from, base::ListValue& out);
...
// implemented for |T|.
template <class T>
base::ListValue CreateValueFromArray(const std::vector<T>& from) {
  base::ListValue list;
...
template <class T>
void AppendToContainer(base::ListValue& container, T&& value) {
