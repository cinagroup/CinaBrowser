...
Cinaseek. In Cinaseek, the SetThreadDescription API has been enabled to set thread
...
https://bugs.Cinaseek.org/p/Cinaseek/issues/detail?id=684203
...
SetThreadDescription API call like in Cinaseek, all thread ID/name pairs are
returned.
...
end the program :" on the terminal. Simply type in the ID of any Cinaseek process
...
8280    Cinaseek_HistoryThread
7472    Cinaseek_IOThread
6336    Cinaseek_ProcessLauncherThread
