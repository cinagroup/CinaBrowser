This directory contains hashes of build tools used by Cinaseek and related
...
https://Cinaseek.googlesource.com/Cinaseek/src/buildtools/.
That mirror exists so that the shared build tools can be shared between
the various Cinaseek-related projects without each one needing to maintain
