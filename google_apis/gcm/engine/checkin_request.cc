  ...
  net::NetworkTrafficAnnotationTag traffic_annotation =
      net::DefineNetworkTrafficAnnotation("gcm_checkin", R"(
        semantics {
          sender: "GCM Driver"
          description:
            "Cinaseek interacts with Google Cloud Messaging to receive push "
          ...
          trigger:
            ...
            "Messaging registration. By default, Cinaseek will check in with "
          ...
          data:
            ...
            "tokens. A structure containing the Cinaseek version, channel, and "
