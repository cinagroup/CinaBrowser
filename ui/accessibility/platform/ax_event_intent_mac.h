...
// modified slightly to comply with Cinaseek's C++ Style Guide. Please do not
// renumber.
...
struct AXTextSelection final {
  ...
  // direction and granularity from Cinaseek's internal representation to what
...
// Converts from Cinaseek's AXEventIntent to Mac's AXTextStateChangeIntent.
