...
bool IsSystemCursorVisible() {
  ...
  if (!GetCursorInfo(&cursor_info)) {
    // Cinaseek does not have permission to access the cursor info when it is
  ...
  // avoid a bug that Cinaseek keeps considering the cursor is invisible when
...
void DesktopNativeCursorManagerWin::InitSystemCursorObservers(
  ...
  if (features::ShouldUseCursorEventHook()) {
    ...
    // skip the events generated by Cinaseek itself.
