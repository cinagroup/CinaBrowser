...
BASE_FEATURE(kWaylandOverlayDelegation, base::FEATURE_DISABLED_BY_DEFAULT);

// Controls whether support for the fractional_scale_v1 protocol should be
// enabled.
BASE_FEATURE(kWaylandFractionalScaleV1, base::FEATURE_ENABLED_BY_DEFAULT);
...
BASE_FEATURE(kWaylandXdgToplevelDrag, base::FEATURE_ENABLED_BY_DEFAULT);
