...
template <typename T>
class PAFlatTreeTest : public testing::Test {};
TYPED_TEST_SUITE_P(PAFlatTreeTest);

// Tests that the compiler generated move operators propagrate noexcept
// specifiers.
TEST(PAFlatTree, NoExcept) {
  struct MoveThrows {
...
TYPED_TEST_P(PAFlatTreeTest, DefaultConstructor) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, CopyConstructor) {
...
TEST(PAFlatTree, MoveConstructor) {
...
TEST(PAFlatTree, RangeConstructor) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, ContainerCopyConstructor) {
...
TEST(PAFlatTree, ContainerMoveConstructor) {
...
TYPED_TEST_P(PAFlatTreeTest, InitializerListConstructor) {
  {
...
TEST(PAFlatTree, SortedUniqueRangeConstructor) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, SortedUniqueContainerCopyConstructor) {
  TypeParam items = {1, 2, 3, 4};
...
TEST(PAFlatTree, SortedUniqueVectorMoveConstructor) {
  using Pair = std::pair<int, MoveOnlyInt>;
...
TYPED_TEST_P(PAFlatTreeTest, SortedUniqueInitializerListConstructor) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, CopyAssignable) {
  TypedTree<TypeParam> original({1, 2, 3, 4});
...
TEST(PAFlatTree, MoveAssignable) {
  int input_range[] = {1, 2, 3, 4};
...
TYPED_TEST_P(PAFlatTreeTest, InitializerListAssignable) {
...
TEST(PAFlatTreeTest, ShrinkToFit) {
  IntTree cont({1, 2, 3});
...
TYPED_TEST_P(PAFlatTreeTest, Clear) {
...
TYPED_TEST_P(PAFlatTreeTest, Size) {
  TypedTree<TypeParam> cont;
...
TYPED_TEST_P(PAFlatTreeTest, Empty) {
  TypedTree<TypeParam> cont;
...
TYPED_TEST_P(PAFlatTreeTest, Iterators) {
  TypedTree<TypeParam> cont({1, 2, 3, 4, 5, 6, 7, 8});
...
TYPED_TEST_P(PAFlatTreeTest, InsertLValue) {
  TypedTree<TypeParam> cont;
...
TYPED_TEST_P(PAFlatTreeTest, InsertPositionLValue) {
  TypedTree<TypeParam> cont;
...
TEST(PAFlatTree, InsertPositionRValue) {
  MoveOnlyTree cont;
...
TEST(PAFlatTree, InsertIterIter) {
...
TYPED_TEST_P(PAFlatTreeTest, Emplace) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, EmplacePosition) {
  {
    EmplaceableTree cont;
...
TYPED_TEST_P(PAFlatTreeTest, Extract) {
  TypedTree<TypeParam> cont;
  cont.emplace(3);
  cont.emplace(1);
  cont.emplace(2);
...
TYPED_TEST_P(PAFlatTreeTest, Replace) {
...
TYPED_TEST_P(PAFlatTreeTest, ErasePosition) {
  {
    TypedTree<TypeParam> cont({1, 2, 3, 4, 5, 6, 7, 8});
...
TYPED_TEST_P(PAFlatTreeTest, EraseRange) {
  TypedTree<TypeParam> cont({1, 2, 3, 4, 5, 6, 7, 8});
...
TYPED_TEST_P(PAFlatTreeTest, EraseKey) {
  TypedTree<TypeParam> cont({1, 2, 3, 4, 5, 6, 7, 8});
...
TYPED_TEST_P(PAFlatTreeTest, EraseEndDeath) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, Count) {
...
TYPED_TEST_P(PAFlatTreeTest, Find) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, Contains) {
  const TypedTree<TypeParam> cont({5, 6, 7, 8, 9, 10, 11, 12});
...
TYPED_TEST_P(PAFlatTreeTest, EqualRange) {
  {
...
TYPED_TEST_P(PAFlatTreeTest, LowerBound) {
  {
    TypedTree<TypeParam> cont({5, 7, 9, 11, 13, 15, 17, 19});
...
TYPED_TEST_P(PAFlatTreeTest, UpperBound) {
  {
    TypedTree<TypeParam> cont({5, 7, 9, 11, 13, 15, 17, 19});
...
TYPED_TEST_P(PAFlatTreeTest, Swap) {
...
TYPED_TEST_P(PAFlatTreeTest, EraseIf) {
...
TYPED_TEST_P(PAFlatTreeTest, SortedUniqueRangeConstructorDCHECKs) {
  int unsorted[] = {2, 1};
  PA_EXPECT_DCHECK_DEATH(TypedTree<TypeParam>(
      sorted_unique, std::begin(unsorted), std::end(unsorted)));

  int repeated[] = {1, 2, 2};
  PA_EXPECT_DCHECK_DEATH(TypedTree<TypeParam>(
      sorted_unique, std::begin(repeated), std::end(repeated)));
}

TYPED_TEST_P(PAFlatTreeTest, SortedUniqueVectorCopyConstructorDCHECKs) {
  TypeParam unsorted = {2, 1};
  PA_EXPECT_DCHECK_DEATH(TypedTree<TypeParam>(sorted_unique, unsorted));

  TypeParam repeated = {1, 2, 2};
  PA_EXPECT_DCHECK_DEATH(TypedTree<TypeParam>(sorted_unique, repeated));
}

TYPED_TEST_P(PAFlatTreeTest, SortedUniqueVectorMoveConstructorDCHECKs) {
  TypeParam unsorted = {2, 1};
  PA_EXPECT_DCHECK_DEATH(
      TypedTree<TypeParam>(sorted_unique, std::move(unsorted)));

  TypeParam repeated = {1, 2, 2};
  PA_EXPECT_DCHECK_DEATH(
      TypedTree<TypeParam>(sorted_unique, std::move(repeated)));
}

TYPED_TEST_P(PAFlatTreeTest, SortedUniqueInitializerListConstructorDCHECKs) {
...
TYPED_TEST_P(PAFlatTreeTest, ReplaceDCHECKs) {
  TypedTree<TypeParam> tree;
  TypeParam unsorted = {2, 1};
  PA_EXPECT_DCHECK_DEATH(tree.replace(std::move(unsorted)));

  TypeParam repeated = {1, 2, 2};
  PA_EXPECT_DCHECK_DEATH(tree.replace(std::move(repeated)));
}

REGISTER_TYPED_TEST_SUITE_P(PAFlatTreeTest,
                            DefaultConstructor,
                            CopyConstructor,
...
INSTANTIATE_TYPED_TEST_SUITE_P(My, PAFlatTreeTest, IntSequenceContainers);
