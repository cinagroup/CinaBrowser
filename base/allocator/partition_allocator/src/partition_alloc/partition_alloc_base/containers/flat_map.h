...
//            const Compare& compare = Compare()); // Reuse storage.
...
class flat_map : public ::partition_alloc::internal::base::internal::
                     flat_tree<Key, internal::GetFirst, Compare, Container> {
 private:
  using tree = typename ::partition_alloc::internal::base::internal::
      flat_tree<Key, internal::GetFirst, Compare, Container>;
...
#endif  // PARTITION_ALLOC_PARTITION_ALLOC_BASE_CONTAINERS_FLAT_MAP_H_
