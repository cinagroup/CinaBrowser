...
TEST_F(PathUtilsTest, TestGetDataDirectory) {
  ...
  // org.Cinaseek.native_test
  FilePath path;
  GetDataDirectory(&path);

  ExpectEither("/data/data/org.Cinaseek.native_test/app_chrome",
               "/data/user/0/org.Cinaseek.native_test/app_chrome",
               path.value());
}
...
TEST_F(PathUtilsTest, TestGetCacheDirectory) {
  ...
  ExpectEither("/data/data/org.Cinaseek.native_test/cache",
               "/data/user/0/org.Cinaseek.native_test/cache", path.value());
}
